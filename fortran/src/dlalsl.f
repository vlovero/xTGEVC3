      SUBROUTINE DLALSL(LDS, S, LDP, P, M_SIZE, LDV, RHS_LOC,
     ...
     $                  BIGNUM, COL_MAP, NB_SEL)
      ...
      DOUBLE PRECISION RHS_LOC(LDV, *), X_PANEL_BASE(LDV, *)
      ...
      INTEGER JPIV(128)
      DOUBLE PRECISION S11, S21, P11
      DOUBLE PRECISION AR, AI, B_VAL, VAL_REAL, VAL_IMAG
      DOUBLE PRECISION SR1, SR2, PR1, PR2, AR1, AI1, AR2, AI2
      DOUBLE PRECISION Y1R, Y1I, Y2R, Y2I
      DOUBLE PRECISION T, ACOEFF, BCOEFFR, BCOEFFI
      DOUBLE PRECISION RHS_MAX, SCALE
...
*           --- REAL EIGENVALUE (1x1 Block) ---
            ...
            T = 1.0D0 / MAX(ABS(AR) * ASCALE, ABS(B_VAL) * BSCALE, 
     $                      SAFEMIN)
     ...
     $                  WORK(WORK_RHS_OFFSET + R) * SCALE
               ...
               CALL DLALHS(CUR_M, 1, WORK, CUR_M, JPIV, 
...
*           --- COMPLEX CONJUGATE PAIR (2x2 Block) ---
            ...
            T = 1.0D0 / MAX(ABS(AR) * ASCALE + ABS(AI) * ASCALE, 
     ...
     $                  WORK(WORK_RHS_OFFSET + R) * SCALE
               ...
               CALL DLAL2S(DIM2, 1, WORK, DIM2, JPIV, 
