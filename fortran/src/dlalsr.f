      SUBROUTINE DLALSR(LDS, S, LDP, P, M_SIZE, LDV, RHS_LOC,
...
*           --- REAL EIGENVALUE (1x1 Block) ---
     ...
     $                  WORK(WORK_RHS_OFFSET + R) * SCALE
               ...
               CALL DLAUHS(CUR_M, 1, WORK, CUR_M, 
